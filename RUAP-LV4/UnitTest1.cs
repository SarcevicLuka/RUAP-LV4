...
namespace SeleniumTests
{
    ...
    public class UntitledTestCase
    {
        ...
        public void TheUntitledTestCase1Test()
        {
            ...
            driver.FindElement(By.Id("input-lastname")).SendKeys("Luka");
            driver.FindElement(By.Id("input-email")).Click();
            driver.FindElement(By.Id("input-email")).Clear();
            driver.FindElement(By.Id("input-email")).SendKeys("luka.sarac@gmail.com");
            ...
            driver.FindElement(By.Id("input-password")).SendKeys("luka25081999");
            driver.FindElement(By.Id("input-confirm")).Click();
            driver.FindElement(By.Id("input-confirm")).Clear();
            driver.FindElement(By.Id("input-confirm")).SendKeys("luka25081999");
