...
namespace SeleniumTests
{
    ...
    public class UntitledTestCase4
    {
        ...
        public void TheUntitledTestCaseTest()
        {
            ...
            driver.FindElement(By.Id("input-email")).SendKeys("nintendo@gmail.com");
            driver.FindElement(By.Id("input-password")).Click();
            driver.FindElement(By.Id("input-password")).Clear();
            driver.FindElement(By.Id("input-password")).SendKeys("nintendo2021");
            driver.FindElement(By.XPath("//input[@value='Login']")).Click();
            driver.FindElement(By.LinkText("//div[@id='dropdown-inner']/ul/li[2]/a/span")).Click();
